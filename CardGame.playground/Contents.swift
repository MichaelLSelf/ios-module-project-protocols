...
init() {
    ...
    func drawCard() -> Card {
           let randomNumber = Int.random(in: 0...52)
...
class HighLow: CardGame {
    ...
    func play() {
        ...
        if player1Card == player2Card {
            print("Round ends in a tie with \(player1Card), therefore Clayton wins")
        } else if player2Card < player1Card {
            print("Bronson wins with \(player1Card)")
        } else if player1Card < player2Card {
            print("Mikey wins with \(player2Card)")
        }
    }
}
...
class CardGameTracker: CardGameDelegate {
    ...
    func game(player1DidDraw card1: Card, player2DidDraw card2: Card) {
        print("Bronson drew \(card1), Mikey drew \(card2)")
